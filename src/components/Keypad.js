...
const Keypad = (props) => {
  ...
  return (
    <div className="button keypad">
        <button className="btn" name="(" onClick={e => onClick(e.target.name)}>(</button>
        <button className="btn" name="CE" onClick={e => onClick(e.target.name)}>CE</button>
        <button className="btn" name=")" onClick={e => onClick(e.target.name)}>)</button>
        ...
        <button id="four" name="4" className="btn" onClick={e => onClick(e.target.name)}>4</button>
